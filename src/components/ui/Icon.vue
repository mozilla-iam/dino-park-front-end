  ...
  >
    ...
    <template v-else-if="id === 'staff'">
      <defs>
        <path
          id="a"
          d="M20.4 0H3.6C1.56 0 0 1.56 0 3.6v16.8C0 22.44 1.56 24 3.6 24h16.8c2.04 0 3.6-1.56 3.6-3.6V3.6C24 1.56 22.44 0 20.4 0zm-4.52 14.743c0 1.067-.385 1.903-1.157 2.51-.77.608-1.834.911-3.19.911-1.357 0-2.467-.21-3.331-.632V15.68c.547.257 1.128.459 1.743.607a7.391 7.391 0 0 0 1.719.221c.776 0 1.35-.148 1.718-.443.37-.295.554-.692.554-1.19 0-.448-.17-.828-.509-1.14-.339-.311-1.039-.68-2.1-1.107-1.093-.443-1.864-.949-2.313-1.518-.448-.568-.673-1.252-.673-2.05 0-1.001.356-1.789 1.067-2.363.71-.574 1.665-.861 2.863-.861 1.148 0 2.291.251 3.429.754l-.624 1.6c-1.066-.448-2.018-.673-2.855-.673-.634 0-1.115.138-1.443.415-.328.276-.492.64-.492 1.095 0 .312.065.578.196.8.132.221.348.43.648.627.301.197.843.457 1.625.78.88.366 1.525.708 1.936 1.025.41.317.71.675.902 1.074.191.4.287.87.287 1.411z"
        />
      </defs>
    ...
    <template v-else-if="id === 'staff-outline'">
      <path
        fill="currentColor"
