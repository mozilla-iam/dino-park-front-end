  ...
  >
    ...
    <template v-else-if="id === 'crown'">
      ...
      <g
        ...
        fill-rule="evenodd"
      >
        <g id="icon-/-crown" transform="translate(-1.000000, 0)">
    ...
    <template v-else-if="id === 'crown-fill'">
      ...
      <g
        ...
        fill-rule="evenodd"
      >
        <g id="icon-/-crown-fill" transform="translate(-1.000000, 0)">
          <mask id="mask-2" fill="white">
          ...
          <use
            ...
            fill="currentColor"
            fill-rule="nonzero"
            xlink:href="#path-crown-fill"
          />
        </g>
      </g>
    </template>
    <template v-else-if="id === 'users'">
      <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" />
      <circle cx="9" cy="7" r="4" />
      <path d="M23 21v-2a4 4 0 0 0-3-3.87" />
      <path d="M16 3.13a4 4 0 0 1 0 7.75" />
    </template>
    <template v-else-if="id === 'mail-outline'">
      <g
        fill="none"
        stroke="currentColor"
        stroke-width="2"
