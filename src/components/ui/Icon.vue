<template>
  ...
  >
    ...
    <template v-else-if="id === 'pencil'">
      <path
        d="M1 14l1.171-5.386L10.658 1c1.138.11 2.069.51 2.793 1.2.724.692 1.24 1.594 1.549 2.708L6.314 13 1 14z"
        stroke="currentColor"
      />
      <path
        d="M2 8c1.314.497 2.195.968 2.644 1.411.449.444.9 1.307 1.356 2.589M1.167 12.2l.666.633"
        stroke="currentColor"
      />
    </template>
  </svg>
