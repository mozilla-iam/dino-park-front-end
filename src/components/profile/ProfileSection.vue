...
.profile__section:not(.profile__section--editing):not(.first) .panel__section-header,
.profile__section:not(.profile__section--editing):not(.first) .profile__section-header {
  margin: calc(-1.5em - 2px) calc(-1.5em - 2px) calc(1.5em + 2px) calc(-1.5em - 2px);
