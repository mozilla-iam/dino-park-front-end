<template>
  ...
  >
    ...
    <template v-else-if="id === 'registered'">
      <path
        fill="currentColor"
        d="M12.75 13.25v1.5c0 .45-.3.75-.75.75s-.75-.3-.75-.75v-1.5c0-1.275-.975-2.25-2.25-2.25H3.75c-1.275 0-2.25.975-2.25 2.25v1.5c0 .45-.3.75-.75.75S0 15.2 0 14.75v-1.5c0-2.1 1.65-3.75 3.75-3.75H9c2.1 0 3.75 1.65 3.75 3.75zm-10.125-9c0-2.1 1.65-3.75 3.75-3.75s3.75 1.65 3.75 3.75S8.475 8 6.375 8s-3.75-1.65-3.75-3.75zm1.5 0c0 1.275.975 2.25 2.25 2.25s2.25-.975 2.25-2.25S7.65 2 6.375 2s-2.25.975-2.25 2.25z"
      />
      <path
        fill="currentColor"
        d="M17.99 5.62c-.027-.108-.109-.161-.218-.188l-1.74-.24-.787-1.552c-.082-.187-.408-.187-.49 0l-.788 1.525-1.712.267c-.109 0-.19.08-.245.187-.027.107 0 .214.082.268l1.25 1.203-.299 1.712a.252.252 0 0 0 .109.267c.081.054.19.08.299.027L15 8.294l1.55.802h.135a.39.39 0 0 0 .163-.054.252.252 0 0 0 .109-.267l-.299-1.712 1.25-1.203c.082-.053.109-.16.082-.24z"
      />
    </template>
    <template v-else-if="id === 'vouched'">
      <path
        fill="currentColor"
        d="M17 19v2c0 .6-.4 1-1 1s-1-.4-1-1v-2c0-1.7-1.3-3-3-3H5c-1.7 0-3 1.3-3 3v2c0 .6-.4 1-1 1s-1-.4-1-1v-2c0-2.8 2.2-5 5-5h7c2.8 0 5 2.2 5 5zM3.5 7c0-2.8 2.2-5 5-5s5 2.2 5 5-2.2 5-5 5-5-2.2-5-5zm2 0c0 1.7 1.3 3 3 3s3-1.3 3-3-1.3-3-3-3-3 1.3-3 3zm18.2 1.3c-.4-.4-1-.4-1.4 0L19 11.6l-1.3-1.3c-.4-.4-1-.4-1.4 0-.4.4-.4 1 0 1.4l2 2c.2.2.5.3.7.3.2 0 .5-.1.7-.3l4-4c.4-.4.4-1 0-1.4z"
      />
    </template>
    ...
    <template v-else-if="id === 'private'">
      ...
      ></path>
      <line fill="currentColor" x1="1" y1="1" x2="23" y2="23"></line>
    </template>
  </svg>
</template>
