...
const MUTATE_PROFILE = gql`mutation UpdateProfile($username: String!, $alternativeName: DisplayStringInput, $description: DisplayStringInput, $firstName: DisplayStringInput, $funTitle: DisplayStringInput, $lastName: DisplayStringInput, $location: DisplayStringInput, $pronouns: DisplayStringInput, $timezone: DisplayStringInput ){ 
