...
access-group-invitations-tab = Invitations
...
access-group_expiration = Expiration
  .checkbox = Membership can expire
  .expiration-description = Membership will expire after how many days
  .update-expiration = Update expiration
access-group_markdown = Markdown Quick Guide
  .intro-part-1 = Use
  .intro-part-link = Markdown
  .intro-part-2 = for bold, italics, lists, and links.
  .bold = Bold text
...
access-group_edit-details = Group details
  .name = Group name
  .description = Group description
  .update-details = Update details
access-group_edit-type = Group type
...
access-group_edit-terms = Membership terms
...
access-group_close-group = Close group
  .part-1 = This action will completely delete the access group and remove all members. To continue, please check the box labelled
  .part-2 = I understand
...
access-group_pending-invitations = Pending Invitations
